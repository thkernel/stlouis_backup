...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { account_id: @table.account_id, name: @table.name, status: @table.status, uid: @table.uid } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { account_id: @table.account_id, name: @table.name, status: @table.status, uid: @table.uid } }
