...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { feature_id: @permission.feature_id, role_id: @permission.role_id, status: @permission.status, uid: @permission.uid } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { feature_id: @permission.feature_id, role_id: @permission.role_id, status: @permission.status, uid: @permission.uid } }
