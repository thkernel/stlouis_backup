...
class ProductCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_category" do
    assert_difference('ProductCategory.count') do
      post product_categories_url, params: { product_category: { account_id: @product_category.account_id, description: @product_category.description, name: @product_category.name, slug: @product_category.slug, status: @product_category.status, uid: @product_category.uid } }
    end
  ...
  test "should update product_category" do
    patch product_category_url(@product_category), params: { product_category: { account_id: @product_category.account_id, description: @product_category.description, name: @product_category.name, slug: @product_category.slug, status: @product_category.status, uid: @product_category.uid } }
